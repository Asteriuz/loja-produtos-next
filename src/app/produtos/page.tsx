  ...
  return (
    <div className="flex flex-col items-center gap-y-8 mt-8">
      ...
      <ul className="flex gap-x-20 text-2xl text-white flex-wrap gap-y-10 items-center justify-center">
        <div className="px-2 bg-laranja-claro hover:bg-white hover:border-laranja-claro hover:border-2 hover:scale-105 transition-all duration-500 ease-in-out py-1 rounded-lg ">
          <li>
            <Link
